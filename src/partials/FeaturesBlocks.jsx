      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">在这里探索解决方案</h2>
            <p className="text-xl text-gray-600">因为有 Solutioner&trade; 的各项 Buff 加成，当发现问题时，只需发送邮件，然后解决问题</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">沙盒空间</h4>
              <p className="text-gray-600 text-center">沙盒空间提供全链路的仿真环境。作为管理员决策前安全演练的空间。</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">热点</h4>
              <p className="text-gray-600 text-center">热点系统将您的视野快速聚焦到引人注目的问题或服务上。</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">风控体系</h4>
              <p className="text-gray-600 text-center">针对不同场景，专门定制风控体系，在风险发生时及时止损。</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">清理工</h4>
              <p className="text-gray-600 text-center">时常扫描，及时清理，修补漏洞，有效预防安全问题。</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">风险广播</h4>
              <p className="text-gray-600 text-center">内置高效风险预警系统，状态实时广播，保持运行过程透明可靠。</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">快在起跑线</h4>
              <p className="text-gray-600 text-center">如同上面所说，即使针对特殊场景，我们也有着不凡的速度。</p>
            </div>
