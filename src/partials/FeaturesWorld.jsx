...
import PlanetAvatar01 from '../images/planet-avatar/1.png';
import PlanetAvatar02 from '../images/planet-avatar/2.png';
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h2 mb-4">从部署这一刻起立即<br />获得高可用性</h1>
            {/* <p className="text-xl text-gray-600">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat cupidatat.</p> */}
            <p className="text-xl text-gray-600">得益于我们全球可用且轻量高效的<strong>边缘网络</strong>，每个请求都拥有 <strong>89.99%</strong> 的正常运行时间。我们的定制工作方案细致到<strong>每一个操作</strong>，为项目带来始终的<strong>高可用性</strong></p> 
          </div>
